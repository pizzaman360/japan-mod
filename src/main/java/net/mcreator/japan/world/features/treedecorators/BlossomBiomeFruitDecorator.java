package net.mcreator.japan.world.features.treedecorators;
...
public class BlossomBiomeFruitDecorator extends CocoaDecorator {
	public static final BlossomBiomeFruitDecorator INSTANCE = new BlossomBiomeFruitDecorator();
	public static com.mojang.serialization.Codec<BlossomBiomeFruitDecorator> codec;
	public static TreeDecoratorType<?> tdt;
	static {
		codec = com.mojang.serialization.Codec.unit(() -> INSTANCE);
		tdt = new TreeDecoratorType<>(codec);
		tdt.setRegistryName("blossom_biome_tree_fruit_decorator");
		ForgeRegistries.TREE_DECORATOR_TYPES.register(tdt);
	}

	public BlossomBiomeFruitDecorator() {
		super(0.2f);
	}
