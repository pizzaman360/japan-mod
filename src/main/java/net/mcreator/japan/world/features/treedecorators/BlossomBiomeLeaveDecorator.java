...
public class BlossomBiomeLeaveDecorator extends LeaveVineDecorator {
	public static final BlossomBiomeLeaveDecorator INSTANCE = new BlossomBiomeLeaveDecorator();
	public static com.mojang.serialization.Codec<LeaveVineDecorator> codec;
	public static TreeDecoratorType<?> tdt;
	static {
		codec = com.mojang.serialization.Codec.unit(() -> INSTANCE);
		tdt = new TreeDecoratorType<>(codec);
		tdt.setRegistryName("blossom_biome_tree_leave_decorator");
